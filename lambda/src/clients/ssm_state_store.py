...
def get_pending_removals(parameter_name):
    """Return the list of pending-removal records stored at this SSM
...
def put_pending_removals(parameter_name, records):
    """Overwrite the pending-removals list at this SSM parameter."""
    _ssm().put_parameter(
        Name=parameter_name,
